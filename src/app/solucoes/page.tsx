    ...
    <>
        ...
        <div className="container mx-auto px-4 md:px-8 py-12 md:py-16">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2">
              ...
              <Link href="https://wa.me/5511973047641?text=Gostaria%20de%20saber%20mais%20sobre%20banda%20larga" className="bg-[#3e4095] text-white font-medium py-2 px-6 rounded-md hover:bg-[#3e4095]/90 transition-colors">
                Solicitar Cotação
              </Link>
            </div>
            <div className="md:w-1/2">
        ...
        <div className="container mx-auto px-4 md:px-8 py-12 md:py-16">
          <div className="flex flex-col md:flex-row-reverse items-center gap-12">
            <div className="md:w-1/2">
              ...
              <Link href="https://wa.me/5511973047641?text=Gostaria%20de%20saber%20mais%20sobre%20o%20chip%20m%C3%B3vel%20" className="bg-[#3e4095] text-white font-medium py-2 px-6 rounded-md hover:bg-[#3e4095]/90 transition-colors">
                Solicitar Cotação
              </Link>
            </div>
            <div className="md:w-1/2">
        ...
        <div className="container mx-auto px-4 md:px-8 py-12 md:py-16">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2">
              ...
              <Link href="https://wa.me/5511973047641?text=Gostaria%20de%20saber%20mais%20sobre%20o%20link%20dedicado" className="bg-[#3e4095] text-white font-medium py-2 px-6 rounded-md hover:bg-[#3e4095]/90 transition-colors">
                Solicitar Cotação
              </Link>
            </div>
            <div className="md:w-1/2">
        ...
        <div className="container mx-auto px-4 md:px-8 py-12 md:py-16">
          <div className="flex flex-col md:flex-row-reverse items-center gap-12">
            <div className="md:w-1/2">
              ...
              <Link href="https://wa.me/5511973047641?text=Gostaria%20de%20saber%20mais%20sobre%20a%20energia%20solar" className="bg-[#3e4095] text-white font-medium py-2 px-6 rounded-md hover:bg-[#3e4095]/90 transition-colors">
                Solicitar Cotação
              </Link>
            </div>
            <div className="md:w-1/2">
      ...
      <section className="bg-[#ccfa1c]">
        <div className="container mx-auto px-4 md:px-8 py-12 md:py-16 text-center">
          ...
          <Link
            href="https://wa.me/5511973047641?text=Gostaria%20de%20saber%20mais%20sobre%20os%20planos"
